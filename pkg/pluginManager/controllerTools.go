...
func (s *pluginControllerReconciler) TaskResourceReconcile(ctx context.Context, taskKind string, ownerTask metav1.Object, agentSpec *crd.AgentSpec, taskStatus *crd.TaskStatus, logger *zap.Logger) (*crd.TaskStatus, error) {
	...
	if taskStatus.Resource == nil {
		if agentSpec == nil {
			resource.RuntimeName = types.ControllerConfig.GeneralAgentName
			resource.RuntimeType = types.ControllerConfig.GeneralAgentType
			if types.ControllerConfig.GereralAgentServiceV4Name != "" {
				resource.ServiceNameV4 = &types.ControllerConfig.GereralAgentServiceV4Name
			}
			if types.ControllerConfig.GereralAgentServiceV6Name != "" {
				resource.ServiceNameV6 = &types.ControllerConfig.GereralAgentServiceV6Name
			}
